...
<body>
	<div>
		...
		<form action="/myOrder/myOrderSignUpProc.do" method="post" onsubmit="return check()">
			...
			아이디 :<input type="text" id="userId" name="id" required placeholder="id"> <br>
			<span class="msg">사용하실 아이디를 입력하고 중복확인을 눌러주세요.</span><br> 
			...
			<span id="alert-danger" style="display: none; color: #d92742; font-weight: bold;">비밀번호가 일치하지 않습니다.</span> <br> <hr>
